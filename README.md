...
> Yes. I used Copilot to generate the API call logic inside the OnInitializedAsync method.
...
> Yes. Copilot quickly generated typed models based on my existing JSON structures in C#. It explained that typed models are better for the purposes of maintainability and documentation.
